class RafflesController < ApplicationController
  ...
  def show
    ...
    if @raffle.rotation_start_date <= Date.today or params[:password] == Raffle::PREVIEW_PASSWORD
      flash.now[:error] = "This raffle has ended. Make sure you don't miss another raffle by <a href='/signup'>signing up for our Daily Deal</a>." if @raffle.rotation_end_date > Date.today
      render :action => 'show'
    else
